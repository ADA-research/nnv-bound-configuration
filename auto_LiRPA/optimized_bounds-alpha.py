...
def _set_alpha(optimizable_activations, parameters, alphas, lr, alphas_0, alphas_1, alphas_2, alphas_3, alphas_4, alphas_5, alphas_6,
               alphas_7, alphas_8, alphas_9, alphas_10, alphas_11, alphas_12, alphas_13, alphas_14, alphas_15, alphas_16, alphas_17, 
               alphas_18, alphas_19, alphas_20, alphas_21):
    """
    ...
    # Random init
    # c = 0
    # for tensor in alphas:
    #     values = [random.uniform(-1., -1.) for _ in range(tensor.shape[3])]
    #     # print(c, values)
    #     for i in range(tensor.shape[0]):
    #         for j in range(tensor.shape[1]):
    #             for k in range(tensor.shape[2]):
    #                 for v in range(len(values)):
    #                     alphas[c][i][j][k].data[v] = values[v]
    #     c += 1
    # SMAC init
    alphas_init = [alphas_0, alphas_1, alphas_2, alphas_3, alphas_4, alphas_5, alphas_6, alphas_7, alphas_8, 
    alphas_9, alphas_10, alphas_11, alphas_12, alphas_13, alphas_14, alphas_15, alphas_16, alphas_17, alphas_18, alphas_19, alphas_20, alphas_21]
    c = 0
    for tensor in alphas:
        values = [alphas_init[c]]*tensor.shape[3]
        # print(c, values)
        for i in range(tensor.shape[0]):
            for j in range(tensor.shape[1]):
                for k in range(tensor.shape[2]):
                    # for v in range(len(values)):
                    with torch.no_grad():
                        alphas[c][i][j][k] = torch.FloatTensor(values)
        c += 1
    ######
...
def get_optimized_bounds(
    ...
    alphas_0 = opts['alphas_0']
    alphas_1 = opts['alphas_1']
    alphas_2 = opts['alphas_2']
    alphas_3 = opts['alphas_3']
    alphas_4 = opts['alphas_4']
    alphas_5 = opts['alphas_5']
    alphas_6 = opts['alphas_6']
    alphas_7 = opts['alphas_7']
    alphas_8 = opts['alphas_8']
    alphas_9 = opts['alphas_9']
    alphas_10 = opts['alphas_10']
    alphas_11 = opts['alphas_11']
    alphas_12 = opts['alphas_12']
    alphas_13 = opts['alphas_13']
    alphas_14 = opts['alphas_14']
    alphas_15 = opts['alphas_15']
    alphas_16 = opts['alphas_16']
    alphas_17 = opts['alphas_17']
    alphas_18 = opts['alphas_18']
    alphas_19 = opts['alphas_19']
    alphas_20 = opts['alphas_20']
    alphas_21 = opts['alphas_21']
    ...
    # Add parameter vector from SMAC here
    if alpha:
        # SMAC: Insert lists with initial alpha values per layer here
        best_alphas = _set_alpha(
            optimizable_activations, parameters, alphas, lr_alpha,
            alphas_0, alphas_1, alphas_2, alphas_3, alphas_4, alphas_5, alphas_6, alphas_7, alphas_8, 
            alphas_9, alphas_10, alphas_11, alphas_12, alphas_13, alphas_14, alphas_15, alphas_16, alphas_17, 
            alphas_18, alphas_19, alphas_20, alphas_21)
